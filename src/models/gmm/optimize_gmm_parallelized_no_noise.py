...
def evaluate_gmm(X, n_clusters, covariance_type, n_init, init_param, max_iter, random_state):
    ...
    current_silhouette_score = silhouette_score(X_no_noise, labels_no_noise)
    current_calinski_harabasz_score = calinski_harabasz_score(X_no_noise, labels_no_noise)
    current_davies_bouldin_score = davies_bouldin_score(X_no_noise, labels_no_noise)
    current_bic_score = gmm.bic(X_no_noise)
    current_aic_score = gmm.aic(X_no_noise)
...
def optimize_gmm_parallelized_no_noise(X: np.array, n_clusters_range: np.array, covariance_type_range: np.array, 
