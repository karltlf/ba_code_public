...
def optimize_optics_parallelized(X,
                                 max_eps_range, 
                                 min_samples_range, 
                                 metrics=['euclidean'], 
    ...
    return {
        ...
        'aic': {
            ...
            'metric': best_aic_result['metric'],
            'cluster_method': best_aic_result['cluster_method'],
            'xi': best_aic_result['xi'] if best_aic_result['cluster_method'] == 'xi' else None
        },
        'bic': {
            'score': best_bic_result['bic_score'],
            'epsilon': best_bic_result['epsilon'],
            'min_samples': best_bic_result['min_samples'],
            'metric': best_bic_result['metric'],
            'cluster_method': best_bic_result['cluster_method'],
            'xi': best_bic_result['xi'] if best_bic_result['cluster_method'] == 'xi' else None
        }
    }
